...
nn5 = NeuralNetwork(2,[256,128],28*28,10,"relu","cross_entropy","Xavier")
nn5.build_network()
opt = optimizer("adam",10,128,0.001,x_train[:1000],y_train_enc[:1000],x_val,y_val_enc,y_val,"cross_entropy",0)
opt.adam(nn5)
y_pred = nn5.predict(x_val)
print(y_pred[:10])
print(nn5.accuracy_score(y_pred,y_val))