...
nn4 = NeuralNetwork(2,[256,128],28*28,10,"relu","cross_entropy")
nn4.build_network()
opt = optimizer("rmsprop",10,128,0.0001,x_train[:1000],y_train_enc[:1000],x_val,y_val_enc,"cross_entropy")
opt.rms_prop(nn4)
