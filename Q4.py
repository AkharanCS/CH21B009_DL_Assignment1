...
def train():
    ...
    nn.build_network()
    optim = optimizer(opt,epochs,batch_size,lr,x_train[:10000],y_train_enc[:10000],x_val,y_val_enc,y_val,"cross_entropy",weight_decay)
    ...
    val_error = optim.cross_entropy_loss(nn,x_val,y_val_enc,weight_decay)
    val_acc = nn.accuracy_score(y_pred_val,y_val)"
    """
